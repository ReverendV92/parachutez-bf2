...
--resource.AddFile("materials/jessev92/bf2_parachute/parachute.vmt")
--resource.AddFile("materials/jessev92/mw2/mw2_para_bf2.vmt")
--resource.AddFile("npc/combine_soldier/zipline_clip1.wav")
--resource.AddFile("npc/combine_soldier/zipline_clip2.wav")
