	...
	*/
	...
	function ENT:Initialize()
		...
		elseif GetConVarString( "vnt_zparachute_mdl" ) == "models/jessev92/frontlines/parachute.mdl" then
			self:SetSkin( 2	)
		elseif GetConVarString( "vnt_zparachute_mdl" ) == "models/jessev92/parachute_gtaiv.mdl" then
			self:SetSkin( 3	)		
		--elseif GetConVarString( "vnt_zparachute_mdl" ) != parachuteCatchTwentyTwo then
		else
			self:SetSkin( 0	)
		end
