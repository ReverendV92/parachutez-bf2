...
SWEP.WorkshopID = "895161301" -- (Integer) Workshop ID number of the upload that contains this file.
...
SWEP.ParachuteModel = Model( "models/jessev92/gtaiv/items/parachute.mdl" ) -- (String) Name of the parachute model while active
