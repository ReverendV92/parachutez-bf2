...
SWEP.WeaponName = "v92_gtaiv_parachute" -- (String) Name of the weapon script
SWEP.WeaponEntityName = "v92_gtaiv_parachute_ent" -- (String) Name of the weapon entity in Lua/Entities/Entityname.lua
SWEP.PrintName = "Just Cause" -- (String) Printed name on menu
SWEP.Category = VNTCB.Category.Parachute -- (String) Category
...
SWEP.WorkshopID = "895912718" -- (Integer) Workshop ID number of the upload that contains this file.
...
SWEP.ParachuteModel = Model( "models/jessev92/justcause/items/parachute.mdl" ) -- (String) Name of the parachute model while active
