...
SWEP.Settings.Weapon = "v92_rnl_parachute" -- (String) Name of the weapon script
...
SWEP.Category = VNT_CATEGORY_RNL -- (String) Category
...
SWEP.Settings.WorkshopID = "895158385" -- (Integer) Workshop ID number of the upload that contains this file.
...
SWEP.Settings.Parachute.Models.Flight = Model( "models/jessev92/rnl/items/parachute.mdl" ) -- (String) Name of the parachute model while active
