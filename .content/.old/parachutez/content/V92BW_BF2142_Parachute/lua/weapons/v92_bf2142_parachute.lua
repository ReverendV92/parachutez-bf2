...
SWEP.WeaponEntityName = "v92_bf2142_parachute_ent" -- (String) Name of the weapon entity in Lua/Entities/Entityname.lua
...
SWEP.WorldModel = Model( "models/jessev92/rnl/weapons/parachute_closed_w.mdl" ) -- (String) World model - w_*
...
SWEP.WorldModelPacked = Model( "models/jessev92/rnl/weapons/parachute_closed_w.mdl" ) -- (String) World model before deployment - w_*
SWEP.WorldModelOpen = Model( "models/jessev92/rnl/weapons/parachute_open_w.mdl" ) -- (String) World model after deployment - w_*
