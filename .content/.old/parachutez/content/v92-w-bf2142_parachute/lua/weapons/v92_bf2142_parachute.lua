...
SWEP.Settings.Weapon = "v92_bf2142_parachute" -- (String) Name of the weapon script
...
SWEP.Category = VNT_CATEGORY_BATTLEFIELD2142 -- (String) Category
...
SWEP.Settings.WorkshopID = "895159273" -- (Integer) Workshop ID number of the upload that contains this file.
...
SWEP.Settings.Parachute.Models.Flight = Model( "models/jessev92/bf2142/items/parachute.mdl" ) -- (String) Name of the parachute model while active
...
SWEP.Settings.Parachute.Models.FlightOffset = Vector( 0 , 0 , 100 ) -- Used to fix the position of models
