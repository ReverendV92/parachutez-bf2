...
SWEP.WeaponName = "v92_rnl_parachute" -- (String) Name of the weapon script
...
SWEP.Category = VNTCB.Category.RnL -- (String) Category
...
SWEP.WorkshopID = "895158385" -- (Integer) Workshop ID number of the upload that contains this file.
