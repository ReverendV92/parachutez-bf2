...
SWEP.Settings.Weapon = "v92_bf3_parachute" -- (String) Name of the weapon script
...
SWEP.Settings.Parachute.Models.PreView = Model( "models/jessev92/weapons/unarmed_c.mdl" ) -- (String) View model before deployment - v_*
