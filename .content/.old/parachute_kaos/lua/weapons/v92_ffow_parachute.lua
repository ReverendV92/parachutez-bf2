...
SWEP.WeaponName = "v92_ffow_parachute" -- (String) Name of the weapon script
...
SWEP.Category = VNT_CATEGORY_FRONTLINES -- (String) Category
...
SWEP.WorkshopID = "895160212" -- (Integer) Workshop ID number of the upload that contains this file.
...
SWEP.ViewModelPacked = Model( "models/weapons/c_arms.mdl" ) -- (String) View model before deployment - v_*
...
SWEP.ParachuteModel = Model( "models/jessev92/ffow/items/parachute.mdl" ) -- (String) Name of the parachute model while active
