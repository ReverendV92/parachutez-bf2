...
if GetConVarNumber( "VNT_Debug_Prints" ) != 0 then	print("[V92] client/cl_ZParachuteRedux.lua Loading...")	end

local zparachuteModelFile = GetConVar( "VNT_ZParachute_Mdl" )
...
list.Set( "DesktopWindows", "ZParaEdit", {
	...
	local currentModel = zparachuteModelFile:GetInt()
	...
	ModelViewer:SetModel( GetConVarString( "VNT_ZParachute_mdl" ) )
	...
	ModelOptions.OptionSelected = function(self,text,model,num)
		...
		ModelViewer.Weapon = nil
		--ModelViewer.Weapon = ClientsideModel( "models/player/kleiner.mdl", RENDERGROUP_BOTH )
	...
	ModelOptions:AddOption( "Just Cause", Model("models/jessev92/justcause/parachute.mdl" ))
	ModelOptions:AddOption( "GTAIV", Model("models/jessev92/gtaiv/parachute.mdl" ))
	ModelOptions:AddOption( "BF2", Model("models/jessev92/bf2/parachute.mdl" ))
	ModelOptions:AddOption( "BF2142", Model("models/jessev92/bf2142/parachute.mdl" ))
	ModelOptions:AddOption( "Kaos", Model("models/jessev92/frontlines/parachute.mdl" ))
	ModelOptions:AddOption( "RnL", Model("models/jessev92/resliber/items/parachute.mdl" ))

	ModelOptions:SetSelected( zparachuteModelFile:GetInt() )
...
if GetConVarNumber( "VNT_Debug_Prints" ) != 0 then	print("[V92] client/cl_ZParachuteRedux.lua Loaded!")	end
