...
if ConVarExists( "vnt_debug_prints" ) and GetConVarNumber( "vnt_debug_prints" ) != 0 then	print("ZParachute Redux - Server File Loading...")	end

-- Parachute Functions 'n Shit

if ConVarExists( "vnt_zparachute_jumpdeploy" ) and GetConVarNumber( "vnt_zparachute_jumpdeploy" ) != 0 then	
	print("ZP - Press Jump to Deploy!")
...
elseif ConVarExists( "vnt_zparachute_jumpdeploy" ) and GetConVarNumber( "vnt_zparachute_jumpdeploy" ) == 0 then	
	function ParachuteKey(_P, _K)
	...
	for k,_P in pairs (player.GetAll()) do
		if _P.Parachuting == true then
			...
			if GetConVarNumber( "vnt_zparachute_behaviour" ) <= 0 then
				...
				elseif GetConVarString( "vnt_zparachute_mdl" ) == "models/jessev92/ww2_rl/parachute.mdl" then					
					if _P:KeyDown(IN_FORWARD) then
...
if GetConVarNumber( "vnt_debug_prints" ) != 0 then	print("ZParachute Redux - Server File Loaded!")	end
