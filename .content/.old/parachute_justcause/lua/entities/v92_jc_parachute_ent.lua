...
ENT.Category = VNT_CATEGORY_JUSTCAUSE
ENT.Spawnable = true
ENT.AdminOnly = false
ENT.SWepName = "v92_gtaiv_parachute" -- (String) Name of the weapon entity in Lua/weapons/swep_name.lua
ENT.WeaponName = ENT.SWepName .. "_ent"	-- (String) Name of this entity
ENT.SEntModel = Model( "models/jessev92/gtaiv/weapons/parachute_harness_w.mdl" ) -- (String) Model to use
