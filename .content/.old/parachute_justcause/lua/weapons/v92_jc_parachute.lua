...
SWEP.Settings.Weapon = "v92_jc_parachute" -- (String) Name of the weapon script
...
SWEP.Category = VNT_CATEGORY_JUSTCAUSE -- (String) Category
...
SWEP.Settings.WorkshopID = "895912718" -- (Integer) Workshop ID number of the upload that contains this file.
...
SWEP.Settings.Parachute.Models.Flight = Model( "models/jessev92/justcause/items/parachute.mdl" ) -- (String) Name of the parachute model while active
