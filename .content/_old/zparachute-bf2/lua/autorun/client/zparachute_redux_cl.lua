...
if GetConVarNumber( "vnt_debug_prints" ) != 0 then	print("ZParachute Redux - Client File Loading...")	end
...
list.Set( "DesktopWindows", "ZParaEdit", {
	...
	ModelOptions:AddOption( "Just Cause", "models/jessev92/justcause/parachute.mdl" )
	ModelOptions:AddOption( "GTAIV", "models/jessev92/gtaiv/parachute.mdl" )
	ModelOptions:AddOption( "BF2", "models/jessev92/bf2/parachute.mdl" )
	ModelOptions:AddOption( "BF2142", "models/jessev92/bf2142/parachute.mdl" )
	ModelOptions:AddOption( "Kaos", "models/jessev92/frontlines/parachute.mdl" )
	ModelOptions:AddOption( "RnL", "models/jessev92/ww2_rl/parachute.mdl" )
...
if GetConVarNumber( "vnt_debug_prints" ) >= 1 then	print("ZParachute Redux - Client File Loaded!")	end
